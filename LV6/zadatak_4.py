...
grid_search = GridSearchCV(
    estimator=svm, param_grid=param_grid, cv=5, scoring="accuracy"
)
...
print(
    f"Optimalne vrijednosti hiperparametara: C={optimal_params['C']}, gamma={optimal_params['gamma']}"
)
...
svm_optimal = SVC(
    kernel="rbf", C=optimal_params["C"], gamma=optimal_params["gamma"], random_state=42
)
