...
# granica odluke za KNN (K=5)
plot_decision_regions(X_train_n, y_train, classifier=knn_model)
plt.xlabel("x_1")
plt.ylabel("x_2")
plt.legend(loc="upper left")
plt.title("KNN (K=5) - trening podaci")
plt.show()

plot_decision_regions(X_test_n, y_test, classifier=knn_model)
plt.xlabel("x_1")
plt.ylabel("x_2")
plt.legend(loc="upper left")
plt.title("KNN (K=5) - test podaci")
plt.show()
...
plt.ylabel("x_2")
plt.legend(loc="upper left")
plt.title("KNN (K=1) - trening podaci")
plt.show()
...
# Plot decision regions for K=100
plot_decision_regions(X_train_n, y_train, classifier=knn_model_k100)
plt.xlabel("x_1")
plt.ylabel("x_2")
plt.legend(loc="upper left")
plt.title("KNN (K=100) - trening podaci")
plt.show()
